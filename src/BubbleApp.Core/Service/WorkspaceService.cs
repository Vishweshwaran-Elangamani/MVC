...
namespace BubbleApp.Core.Service
{
    public class WorkspaceService : IWorkspaceService
    {
        ...
        public async Task<WorkspaceDto> RotateKeyAsync(string workspaceId, CancellationToken ct = default)
        {
        ...
        public async Task<string> GetKeyPreviewAsync(string workspaceId, CancellationToken ct = default)
        {
        ...
        public async Task<WorkspaceAppearanceDto> GetAppearanceAsync(string workspaceId, CancellationToken ct = default)
        {
            var ws = await _repo.GetByIdAsync(workspaceId, ct)
                     ?? throw new InvalidOperationException("Workspace not found.");
            // Defaults if not set
        ...
        public async Task UpdateAppearanceAsync(string workspaceId, UpdateAppearanceRequest req, CancellationToken ct = default)
        {
